...
type Property = { id: string; client_code: string; property_name: string; preferred_language: string; client_status: string; task_email?: string | null; calendar_sheet_code?: string | null; package_name?: string | null; notes?: string | null; legal_name?: string | null; description?: string | null; address_line_1?: string | null; address_line_2?: string | null; city?: string | null; country?: string | null; timezone?: string | null; currency_code?: string | null; check_in_time?: string | null; check_out_time?: string | null; total_rooms?: number | null; website_url?: string | null; map_url?: string | null; logo_url?: string | null };
