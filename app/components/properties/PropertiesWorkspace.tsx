...
type RoomType = { id: string; room_code: string; room_name: string; description: string | null; room_count: number; max_adults: number; max_children: number; max_occupancy: number; bed_configuration: string | null; is_active: boolean };
