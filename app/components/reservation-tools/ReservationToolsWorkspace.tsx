...
import { BadgePercent, BarChart3, FileSearch, Megaphone, Plus, ScanSearch } from "lucide-react";
...
type ToolKey = "ota-audit" | "ota-promotions" | "competitor-analysis" | "revenue-planner" | "social-creator";
...
export default function ReservationToolsWorkspace() {
  ...
  return <section className="nkh-tools">
    ...
    <div className="nkh-tool-stage">
      {activeTool === "ota-audit" ? <OtaAuditTool/> : activeTool === "ota-promotions" ? <OtaPromotionsTool/> : activeTool === "competitor-analysis" ? <CompetitorAnalysisTool/> : activeTool === "revenue-planner" ? <RevenuePlannerTool/> : <SocialMediaCreatorTool/>}
    </div>
  </section>;
}
