...
export default function RosterWorkspace() {
  ...
  const shiftAccent = (entry: Entry, person?: Staff) => entry.shift_label === "Digital Marketing" ? "#7C3AED" : (person?.color_hex || "#E98A15");
  const shiftTint = (entry: Entry, person?: Staff) => {
    const hex = shiftAccent(entry, person).replace("#", "");
    ...
    return `rgba(${red}, ${green}, ${blue}, 0.07)`;
  };
